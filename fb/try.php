                            ...
                            <div class="other-detail">
                                ...
                                <div class="price-style">
                                    ...
                                    <form method="post" action="try.php">
                                        ...
                                        $row['price'];
                                        ?>
                                    <input type="checkbox" name="box[]" value="<?php echo $row['item_id'] ?>">
                                            <button class="btn btn-warning btn-style" name="btnitem" onclick="Display()">Add to Cart </button>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <table class="table table-bordered" id="myCart" >
                ...
                while($row=mysqli_fetch_assoc($qurey)){
                    foreach ($item as $key => $values) {
                        if($row['item_id']==$values)
                        { $_SESSION["id"]=$row['item_id'];
                            ?>
